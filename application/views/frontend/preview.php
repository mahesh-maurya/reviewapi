...
<head>
    ...
    <script src="<?php echo base_url('frontassets/jquery/jquery.js'); ?>"></script>
    <script src="<?php echo base_url('frontassets/jquery/html5lightbox.js'); ?>"></script>
...
<!--                                <img src="bower_components/img/logo.png">-->
                        ...
                        <div class="col-xs-5 col-md-4 text-center">
                            ...
                            <ul class="hidden-xs hidden-sm">
                                ...
                                <a href="<?php echo site_url('website/preview');?>" class="active">
                                    <li>Preview</li>
                                </a>
...
margin: auto;">
                            ...
                            <ul>
                                ...
                                <a href="preview.html" class="active">
                                    <li>Preview</li>
                                </a>
                                <a href="explore.html">
                                    <li>Explore</li>
